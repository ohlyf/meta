...
var require_AnimatePresence = __commonJS({
  "../../node_modules/.pnpm/@tamagui+animate-presence@1.74.8_react@18.2.0/node_modules/@tamagui/animate-presence/dist/cjs/AnimatePresence.js"(exports, module2) {
    ...
    var AnimatePresence2 = /* @__PURE__ */ __name(({
      ...
      const isClientMounted = (0, import_web16.useDidFinishSSR)(), forceRenderLayoutGroup = (0, import_react43.useContext)(import_LayoutGroupContext2.LayoutGroupContext).forceRender;
...
var NativeSelectFrame = (0, import_core34.styled)(ThemeableStack, {
  ...
  variants: {
    size: {
      "...size": (val, extras) => {
        const { tokens } = extras, paddingHorizontal = (0, import_core34.getVariableValue)(tokens.space[val]);
        return {
          borderRadius: tokens.radius[val] ?? val,
          minHeight: tokens.size[val],
...
var SliderFrame = (0, import_core35.styled)(DirectionalYStack, {
  ...
  variants: {
    size: (val, extras) => {
      if (!val)
        return;
      const orientation = extras.props.orientation, size2 = Math.round((0, import_core35.getVariableValue)((0, import_get_token6.getSize)(val)) / 6);
...
var getThumbSize = /* @__PURE__ */ __name((val) => {
  const tokens = (0, import_core36.getTokens)(), size2 = typeof val == "number" ? val : (0, import_get_token7.getSize)(tokens.size[val], {
    shift: -1
  });
  return {
    width: size2,
...
var SliderThumb = SliderThumbFrame.styleable(function(props, forwardedRef) {
  const { __scopeSlider, index: index3, size: sizeProp, ...thumbProps } = props, context = useSliderContext(THUMB_NAME, __scopeSlider), orientation = useSliderOrientationContext(THUMB_NAME, __scopeSlider), [thumb, setThumb] = React30.useState(null), composedRefs = useComposedRefs(
    forwardedRef,
    (node) => setThumb(node)
  ), value = context.values[index3], percent = value === void 0 ? 0 : convertValueToPercentage(value, context.min, context.max), label = getLabel(index3, context.values.length), sizeIn = sizeProp ?? context.size ?? "$true", [size2, setSize] = React30.useState(() => (0, import_core36.getVariableValue)(getThumbSize(sizeIn).width)), thumbInBoundsOffset = size2 ? getThumbInBoundsOffset(size2, percent, orientation.direction) : 0;
  React30.useEffect(() => {
    if (thumb)
...
var ToggleGroup = (0, import_web14.withStaticProperties)(
  import_react38.default.forwardRef(
    (props, forwardedRef) => {
      ...
      if (import_web14.isWeb || import_react38.default.useEffect(() => {
        if (props.id)
...
var Spinner = YStack.extractable(
  (0, import_core51.themeable)(
    React38.forwardRef((props, ref) => {
      ...
      let color = colorProp;
      return color && color[0] === "$" && (color = (0, import_core51.variableToString)(theme[color])), /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(YStack, { ref, ...stackProps, children: /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(import_react_native13.ActivityIndicator, { size: size2, color }) });
    }),
    {
