import OhlyfLcButtonMeta from '/Users/liyunfu/Documents/meta/components/packages/lc-button/lowcode/ohlyf-lc-button/meta'
...
function fillRealVersion(meta, packageName = '@ohlyf/lc-button', version = '0.1.0', basicLibraryVersion={"@alifd/next":"1.25.23","@alifd/meet":"2.6.3","antd":"4.17.3"}) {
  if (!meta || !version) {
    return meta;
  }
  const { npm } = meta;
...
const componentMetas = [OhlyfLcButtonMeta];
const components = [];
const npmInfo = {};
...
if (!execCompile) {
  window.OhlyfLcButtonMeta = { components, componentList };
}